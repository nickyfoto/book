...
**Anthropic** · [Source](http://twitter.macworks.dev/AnthropicAI/status/2061796327986454883#m)
Anthropic expanded Project Glasswing, rolling out access to its Claude Mythos Preview to approximately 150 additional organizations across more than fifteen countries. At the same time, the company publicly praised a recent US Executive Order on AI, framing it as an important measure for strengthening American leadership in the AI sector.

## Also Noted
- **Y Combinator** ([Source](http://twitter.macworks.dev/Tanner_H_Jones/status/2061832356189573602#m)): The newest batch features heavy hardware and vertical agent investments, including AICE's autonomous maritime drones and Justinian, a comprehensive legal agent powered by the largest newly assembled database of American legal texts.
- **Google Cloud** ([Source](http://twitter.macworks.dev/GoogleCloudTech/status/2061930861818270017#m)): Released Agent Executor, a new open-source runtime standard intended to manage robust agent execution, secure isolation, and distributed deployment.
- **Roblox** ([Source](http://twitter.macworks.dev/xxunhuang/status/2061939239915528653#m)): Acquired the Morpheus AI team to integrate real-time video world models into the Roblox game engine, replacing offline pre-rendered AI video generation with interactive, simulated worlds.
- **OpenClaw** ([Source](http://twitter.macworks.dev/openclaw/status/2061869633624580452#m)): Announced a strategic partnership with Microsoft to natively secure its agent framework within Windows and Microsoft enterprise ecosystems.
- **Hugging Face** ([Source](http://twitter.macworks.dev/julien_c/status/2061791189221650463#m)): The platform has doubled its total storage footprint in just five months and is currently on track to surpass 1 Exabyte of data before the end of the year.
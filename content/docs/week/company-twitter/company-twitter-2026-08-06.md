...
**Hadrian** · [Source](http://twitter.macworks.dev/HadrianInc/status/2085327390033752461#m)
Precision manufacturing startup Hadrian has announced a massive \$1.37 billion Series D funding round at a \$7.87 billion valuation, highlighting strong investor confidence in physical AI and national defense logistics. The round was co-led by WCM, Washing Harbour, Valor, 137 Ventures, and Baillie Gifford, with JPMorgan's Strategic Investment Group acting as an anchor co-lead. Hadrian plans to use the capital to accelerate its mission to reindustrialize American manufacturing, betting heavily on physical AI in the "world of atoms" over digital-only solutions.

**Starcloud** · [Source](http://twitter.macworks.dev/ycombinator/status/2085003603727794419#m)
Space-compute pioneer Starcloud has revealed a rapid scaling timeline, raising \$200 million and hitting a \$1 billion valuation just 17 months after graduating from Y Combinator. Starcloud successfully trained the first large language model in orbit in November 2025 using a single Nvidia H100 GPU and has now filed with the FCC to deploy a constellation of 88,000 compute satellites. The company's business model is built on taking advantage of abundant solar energy in orbit, bypassing earthbound cooling and regulatory bottlenecks despite the massive transport and comms costs associated with orbital hardware.

## Also Noted
- **Google Maps** ([Source](http://twitter.macworks.dev/Google/status/2085374532802470329#m)): Expanded its AI-powered "Ask Maps" conversational experience to six new countries, introducing real-time transit updates and secure Gmail integration to automatically reference hotel and flight bookings.
- **Cursor** ([Source](http://twitter.macworks.dev/cursor_ai/status/2085390483740676365#m)): Released details on Cursor Router, an intelligent classification system that dynamically routes user queries across models like Grok, GPT-5.6, and Opus to minimize developer costs and latency.
- **SpaceFlow** ([Source](http://twitter.macworks.dev/Emrre_isik/status/2085398352263610722#m)): Launched its YC S26 autonomous procurement engine, managing \$400 million in supplier spend within customized, on-premise SAP enterprise environments.
- **Olio Labs** ([Source](http://twitter.macworks.dev/OlioLabsInc/status/2085048386026180686#m)): Unveiled its in vivo drug discovery platform designed to predict human clinical outcomes from a single high-throughput experiment.
- **Relativity Space** ([Source](http://twitter.macworks.dev/relativityspace/status/2085423947278061620#m)): Commenced Stage 2 testing at NASA Stennis, completing cryoproof and pressurization milestones ahead of its integrated stage hot fire campaign.

***

🎧 This digest would make a solid audio briefing if you'd like a quick podcast-style breakdown of today's developments.
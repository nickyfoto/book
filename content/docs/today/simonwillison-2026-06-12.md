...
**OpenAI WebRTC Audio Session, now with document context** · [Source](https://simonwillison.net/2026/Jun/12/openai-webrtc/#atom-everything)
...
**Quoting Andrew Singleton** · [Source](https://simonwillison.net/2026/Jun/12/andrew-singleton/#atom-everything)
...
## Project Pulse
Simon continues his pragmatic trend of building custom, browser-based API playgrounds to test multi-modal features like audio and document context long before they are finalized in mainstream consumer apps.